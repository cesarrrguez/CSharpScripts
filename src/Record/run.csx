...
// RECORDS
var personAsRecord = new PersonAsRecord("John Smith", new DateOnly(1990, 12, 1));
var personAsRecord2 = new PersonAsRecord("John Smith", new DateOnly(1990, 12, 1));
...
var personAsRecordOlder = personAsRecord with { DateOfBirth = new DateOnly(1980, 12, 1) };
